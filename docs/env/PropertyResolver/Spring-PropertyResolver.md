...
- [MutablePropertySources 解析](/docs/env/PropertyResolver/Spring-PropertySources.md)
...
这个类的解析详情: [PropertySourcesPropertyResolver](/docs/env/PropertyResolver/Spring-PropertySourcesPropertyResolver.md)
